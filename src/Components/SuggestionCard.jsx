...
const SuggestionCard = ({ data }) => {
  return (
    <div className="w-80 h-[22rem] space-y-4 rounded-xl hover:scale-105 transition-all duration-300 ease-in-out shadow-lg font-Playfair cursor-pointer overflow-hidden dark:bg-gray-800">
      <img
        src={data?.imageUrl}
        alt="image"
      ...
      <div className="px-7 py-4 space-y-4">
        ...
        <h3 className="text-lg font-semibold dark:text-white">{data?.location}</h3>
